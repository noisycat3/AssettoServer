...
public class ACExtraConfiguration
{
    ...
    [YamlMember(Description = "Maximum time for the client to validate the checksums, in seconds")]
    public int MaxChecksumWaitTime { get; set; } = 30;
...
public partial class AiParams
{
    ...
    public float SplineHeightOffsetMeters = 0;
    ...
    public float CorneringBrakeForceFactor = 1;
    ...
    public float TtrafficDensity = 1.0f;
    ...
    public float TyreDiameterMeters = 0.65f;

    [YamlMember(Description = "Size of the cell on spatial grid")]
    public float SpatialHashMapCellSize { get; set; }
